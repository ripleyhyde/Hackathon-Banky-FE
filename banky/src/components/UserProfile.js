    ...
    .map((myrec) => (
      <div className="post">
        <div className="img-post">
          <img className="img-size-recipe" src={myrec.image} alt="" />
        </div>
